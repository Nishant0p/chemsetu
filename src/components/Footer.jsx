        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 items-center">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><a href="#" className="text-gray-300 hover:text-[#00A651] transition-colors">Research Papers</a></li>
              <li><a href="#" className="text-gray-300 hover:text-[#00A651] transition-colors">Terms & Conditions</a></li>
              <li><a href="#" className="text-gray-300 hover:text-[#00A651] transition-colors">Privacy Policy</a></li>
            </ul>
          </div>
